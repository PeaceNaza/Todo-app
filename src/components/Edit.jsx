...
const Edit = ({editTodo, task,}) => {
  ...
  return (
     <form  className="ml-5 mb-3 text-xs" onSubmit={handleSubmit}>

        <input type="text" value={value} onChange={(e) => setValue(e.target.value)} placeholder="Edit task" className="placeholder:text-indigo-950 placeholder:text-xs p-2 w-[300px] rounded-md outline-none" />
