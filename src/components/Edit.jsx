...
const Edit = ({editTodo, task,}) => {
  ...
  return (
     <form  className="ml-5 mb-2 text-xs text-wrap" onSubmit={handleSubmit}>
        ...
        <input type="text" value={value} onChange={(e) => setValue(e.target.value)} placeholder="Edit task" className="placeholder:text-indigo-950 placeholder:text-xs p-2 w-[350px] h-10 rounded-md outline-none mt-2" />
